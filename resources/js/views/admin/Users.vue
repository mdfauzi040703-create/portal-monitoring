  ...
  <div>
    ...
    <div v-else class="bg-white border border-gray-200 rounded-xl overflow-hidden">
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr v-for="(u, i) in users" :key="u.id" class="border-b border-gray-50 hover:bg-gray-50">
            ...
            <td class="px-4 py-3">
<span :class="roleClass(u.role)" class="text-xs px-2.5 py-1 rounded-full font-medium inline-flex items-center gap-1">
      ...
      <div class="bg-white rounded-2xl p-6 w-80 border border-gray-200 shadow-xl">
        ...
        <div class="space-y-3">
          ...
          <div>
            ...
            <select v-model="form.role" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400">
  ...
  <option value="pic">PIC</option>
        ...
        <div class="flex gap-2 justify-end mt-5">
          ...
          <button @click.stop="deleteUser(u.id)"
  class="flex items-center gap-1 text-xs text-red-500 hover:text-red-700 transition px-2 py-1 rounded hover:bg-red-50">
  ...
  try {
    ...
    if (data?.errors) {
      ...
      Object.keys(data.errors).forEach(k => {
        errors.value[k] = data.errors[k][0]
      })
    } else {
