  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <aside class="fixed top-0 left-0 h-full w-56 bg-white border-r border-gray-200 z-50 flex flex-col">
      ...
      <div class="px-5 py-5 border-b border-gray-100">
        ...
        <div class="text-xs text-gray-400 mt-0.5">Approval Drawing SBU</div>
      </div>

      <!-- Menu -->
<nav class="flex-1 px-3 py-4 space-y-1">
<router-link to="/" exact exact-active-class="menu-active" active-class=""
  ...
  <router-link to="/pic" active-class="menu-active"
    class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-900 transition w-full">
    ...
    <div class="ml-56">
      ...
      <header class="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between sticky top-0 z-40">
        ...
        <div class="flex items-center gap-2">
          <div v-if="alertCount > 0" class="flex items-center gap-1.5 bg-red-50 text-red-600 text-xs px-3 py-1.5 rounded-full border border-red-200">
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
            {{ alertCount }} Alert Aktif
          </div>
...
const pageTitle = computed(() => pageTitles[route.path] || 'Portal Monitoring')
